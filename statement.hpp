...
public:
    LetStatement(TokenScanner& scanner, Program &program);
    ~LetStatement();
...
public:
    InputStatement(TokenScanner& scanner, Program &program);
    void execute(EvalState &state, Program &program) override;
private:
    std::string var;
};
...
public:
    IfStatement(TokenScanner& scanner,const std::string& _line);
    ~IfStatement();
    void execute(EvalState &state, Program &program) override;
private:
    int toLine;
