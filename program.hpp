...
private:
    ...
    // whether the program jumped to any other line in this step
    bool jumped;

    // the current line number during execution
    int currentLine;

    // the state indicating whether running progress is finished
    bool finishedFlag;
